            ...
            <MenuList overflowY="scroll" maxHeight="30vh">
              <MenuOptionGroup title="Select one" type="radio">
                {booze?.bases.map((base) =>
                  (<MenuItemOption value={base} key={base}>{base}</MenuItemOption>)
                )}
              </MenuOptionGroup>
              </MenuList>
          </Menu>
            ...
            <MenuList overflowY="scroll" maxHeight="30vh">
              <MenuOptionGroup title="Select all" type="checkbox">
                {booze?.categories.map((category) =>
                  (<MenuItemOption value={category} key={category}>{category}</MenuItemOption>)
                )}
              </MenuOptionGroup>
            </MenuList>
          </Menu>
            ...
            <MenuList overflowY="scroll" maxHeight="30vh">
              <MenuOptionGroup title="Select one" type="radio">
                {booze?.glasses.map((glass) =>
                  (<MenuItemOption value={glass} key={glass}>{glass}</MenuItemOption>)
                )}
              </MenuOptionGroup>
              </MenuList>
          </Menu>
            ...
            <MenuList overflowY="scroll" maxHeight="30vh">
              <MenuOptionGroup title="Select all" type="checkbox">
                {booze?.ingredients.map((ingredient) =>
                  (<MenuItemOption value={ingredient.id} key={ingredient.name}>{ingredient.name}</MenuItemOption>)
                )}
              </MenuOptionGroup>
              </MenuList>
          </Menu>
